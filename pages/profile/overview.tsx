...
const Overview = () => {
    return (
        <PaperStyled variant="outlined">
            <Box className="name">
                <Image layout="intrinsic" className="image" src="https://leonardo.osnova.io/18c6cdd0-ea0e-536a-a98b-1db21c6c4d2a/-/scale_crop/300x300/-/format/webp/" height={500} width={500}  />
                <Box>
